...
const categories = [
  { name: "Video & Audio", accent: "from-cyan-400/20", tools: [
    ...
    { slug: "ai-noise-remover", name: "AI Noise Remover", description: "Remove fan noise, hiss, hum and background noise from recordings.", formats: "MP3 · WAV · M4A · MP4", icon: "audio" as const, featured: true },
