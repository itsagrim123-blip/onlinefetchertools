...
export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.16),_transparent_35%),linear-gradient(180deg,#020817_0%,#0f172a_100%)] text-slate-100">
      <Header />
      <section className="mx-auto max-w-7xl px-4 pb-10 pt-10 text-center sm:px-6 sm:pb-16 sm:pt-20 lg:px-8 lg:pt-28">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:pb-20 sm:px-6 lg:px-8"><ToolCatalog /></section>
      <Footer />
    </main>
  );
}
