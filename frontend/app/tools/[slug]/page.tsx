        ...
        <div className="mx-auto max-w-4xl pb-10 pt-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-400">
            {isYoutube
              ...
              : isVideoEditor
              ? "Trim, cut, resize, and edit videos directly with high quality output and preserved audio."
              : "A focused, privacy-friendly utility that processes your files through the Online Fetcher Tools backend."}
          </p>
        </div>
        {isYoutube ? <DownloaderCard /> : isVideoEditor ? <VideoEditorWorkspace /> : <FileToolWorkspace slug={slug} />}
